...
public class Player3 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (modeDeJeu == 2 || modeDeJeu == 3)
        {
            ...
            if (Pausem == true || (move.all == false && winner.isDeath[2] == false))
            {
        ...
        if (death == true && Pausem == false)
        {
            ...
            {
                if (modeDeJeu != 3 && winner.isDeath[2] == false && winner.isDeath[1] == true && winner.isDeath[0] == true && winner.isDeath[3] == true)
                {
                }
                else
                {
        ...
        if (move.turn == false && (winner.restart[2] == true || move.all))
        {
            particle.gameObject.SetActive(false);
            gameObject.GetComponent<CircleCollider2D>().enabled = true;
            gameObject.GetComponent<SpriteRenderer>().enabled = true;
        ...
        if (winner.isDeath[2] == false && winner.isDeath[1] == true && winner.isDeath[0] == true && winner.isDeath[3] == true)
        {
            avanceButton = false;
            JoystickP1.dash = false;
            DashTimer = 5;
    ...
    private void OnTriggerEnter2D(Collider2D other)
    {
        ...
        {
            if (FindObjectOfType<Player2re>().drapeau == false && FindObjectOfType<Player1re>().drapeau == false && FindObjectOfType<Player4>().drapeau == false)
            {
                drapeau = true;

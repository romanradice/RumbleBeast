...
public class Player1re : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (modeDeJeu == 1)
        {
            ...
            if (JoystickP1.dash == true && DashTimer <= 0 && Pausem == false )
            {
        ...
        if (modeDeJeu == 2 || modeDeJeu == 3)
        {
            ...
            if (Pausem == true ||(move.all == false && winner.isDeath[0] == false))
            {
        ...
        if (death == true && Pausem == false)
        {
            ...
            {
                if (modeDeJeu != 3 && winner.isDeath[0] == false && winner.isDeath[1] == true && winner.isDeath[2] == true && winner.isDeath[3] == true)
                {
                }
                else
                {
        ...
        if (move.turn == false && (winner.restart[0] == true || move.all) )
        {
            particle.gameObject.SetActive(false);
            gameObject.GetComponent<CircleCollider2D>().enabled = true;
            gameObject.GetComponent<SpriteRenderer>().enabled = true;
        ...
        if (winner.isDeath[0] == false && winner.isDeath[1] == true && winner.isDeath[2] == true && winner.isDeath[3] == true)
        {
            avanceButton = false;
            JoystickP1.dash = false;
            DashTimer = 5;
    ...
    private void OnCollisionEnter2D(Collision2D other)
    {
        ...
        if (other.gameObject.tag == "Player4" && PlayerPrefs.GetInt("Son") == 1)
        {
            SonGame.SetActive(false);
            SonGame.SetActive(true);
        }
        ...
        if (modeDeJeu == 3)
        {
            if (drapeau == false)
            {
                ...
                if (other.gameObject.tag == "Player4" && FindObjectOfType<Player4>().drapeau == true && FindObjectOfType<Player4>().TimerHit <= 0 && TimerHit <= 0)
                {
                    drapeau = true;
    ...
    private void OnTriggerEnter2D(Collider2D other)
    {
        ...
        {
            if (FindObjectOfType<Player2re>().drapeau == false && FindObjectOfType<Player3>().drapeau == false && FindObjectOfType<Player4>().drapeau == false )
            {
                drapeau = true;
